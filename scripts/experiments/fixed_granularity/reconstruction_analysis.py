...
def main():
    ...
    for (ri, r) in df.iterrows():
        ...
        data_path = f'/spaths/experiments/{EXPNAME}_fixed_granularity/{r.id}_{r.door}_aggregated.npz'
    ...
    fig.write_html(f'/spaths/experiments/{EXPNAME}_fixed_granularity_recon.html')
